...
describe('OrganizationsTable', () => {
  ...
  test('Mock mutation for addOrganization', async () => {
    ...
    const response = await Mutations.addOrganization(wrapper.vm.$apollo, 'Name');
  ...
  test('Mock mutation for addDomain', async () => {
    ...
    const response = await Mutations.addDomain(wrapper.vm.$apollo, 'domain.com', 'Organization');
  ...
  test('Mock mutation for deleteOrganization', async () => {
    ...
    const response = await Mutations.deleteOrganization(wrapper.vm.$apollo, 'Organization');
    expect(mutate).toBeCalled();
    expect(wrapper.element).toMatchSnapshot();
  });
});
