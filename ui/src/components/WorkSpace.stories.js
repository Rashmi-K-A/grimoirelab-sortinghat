...
export const DragAndDrop = () => ({
  ...
  methods: {
    queryIndividuals(page, items, filters) {
      ...
      if (filters.term) {
        results.data.individuals.entities = results.data.individuals.entities.filter((individual) =>
          individual.profile.name.toUpperCase().includes(filters.term.toUpperCase()),
        );
