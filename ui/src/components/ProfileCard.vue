<template>
  ...
  >
    <v-list-group>
      ...
      <v-list-group sub-group :key="source.name" v-for="source in identities" value="true">
        <template v-slot:activator>
          <v-list-item-icon>
    ...
    <v-list-group>
      ...
      <v-list-item v-for="enrollment in enrollments" :key="enrollment.organization.id">
        <v-list-item-content>
          <v-row no-gutters>
